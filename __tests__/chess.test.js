  ...
  const tests = [
    {
      ...
      board: [
        [
          { type: 'r', square: 'a8', color: 'b' },
          { type: 'n', square: 'b8', color: 'b' },
          { type: 'b', square: 'c8', color: 'b' },
          { type: 'q', square: 'd8', color: 'b' },
          { type: 'k', square: 'e8', color: 'b' },
          { type: 'b', square: 'f8', color: 'b' },
          { type: 'n', square: 'g8', color: 'b' },
          { type: 'r', square: 'h8', color: 'b' },
        ],
        [
          { type: 'p', square: 'a7', color: 'b' },
          { type: 'p', square: 'b7', color: 'b' },
          { type: 'p', square: 'c7', color: 'b' },
          { type: 'p', square: 'd7', color: 'b' },
          { type: 'p', square: 'e7', color: 'b' },
          { type: 'p', square: 'f7', color: 'b' },
          { type: 'p', square: 'g7', color: 'b' },
          { type: 'p', square: 'h7', color: 'b' },
        ],
        ...
        [null, null, null, null, null, null, null, null],
        [
          { type: 'p', square: 'a2', color: 'w' },
          { type: 'p', square: 'b2', color: 'w' },
          { type: 'p', square: 'c2', color: 'w' },
          { type: 'p', square: 'd2', color: 'w' },
          { type: 'p', square: 'e2', color: 'w' },
          { type: 'p', square: 'f2', color: 'w' },
          { type: 'p', square: 'g2', color: 'w' },
          { type: 'p', square: 'h2', color: 'w' },
        ],
        [
          { type: 'r', square: 'a1', color: 'w' },
          { type: 'n', square: 'b1', color: 'w' },
          { type: 'b', square: 'c1', color: 'w' },
          { type: 'q', square: 'd1', color: 'w' },
          { type: 'k', square: 'e1', color: 'w' },
          { type: 'b', square: 'f1', color: 'w' },
          { type: 'n', square: 'g1', color: 'w' },
          { type: 'r', square: 'h1', color: 'w' },
        ],
      ],
    },
    // checkmate
    {
      ...
      board: [
        ...
        [
          null,
          null,
          { type: 'n', square: 'c6', color: 'b' },
          null,
          { type: 'p', square: 'e6', color: 'b' },
          null,
          { type: 'p', square: 'g6', color: 'b' },
          null,
        ],
        [null, null, null, null, null, null, null, null],
        [
          null,
          null,
          { type: 'b', square: 'c4', color: 'w' },
          null,
          null,
          { type: 'p', square: 'f4', color: 'w' },
          null,
          { type: 'q', square: 'h4', color: 'b' },
        ],
        [
          null,
          null,
          { type: 'n', square: 'c3', color: 'w' },
          { type: 'p', square: 'd3', color: 'w' },
          { type: 'b', square: 'e3', color: 'b' },
          null,
          { type: 'n', square: 'g3', color: 'b' },
          null,
        ],
        [
          { type: 'p', square: 'a2', color: 'w' },
